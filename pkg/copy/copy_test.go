...
func TestCopyDir(t *testing.T) {
	...
	assert.NilError(t, filepath.Walk(srcDir, func(srcPath string, f os.FileInfo, err error) error {
		...
		assert.Check(t, is.DeepEqual(srcFileSys.Mtimespec, dstFileSys.Mtimespec))
...
func doCopyTest(t *testing.T) {
	...
	assert.NilError(t, copyRegular(srcFilename, dstFilename, fileinfo))
